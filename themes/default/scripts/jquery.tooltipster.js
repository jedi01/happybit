...
(function( $ ) {
	...
	$.fn.tooltipster = function( options ) {
		...
		var settings = $.extend({
			...
			tooltipClass: '.regpagetip',
			tooltipClass: '.quickauctions',
		}, options);
		...
		return this.hover(function() {
			...
			if (settings.arrow == true){
				...
				if (!arrow_reposition) {
					...
					arrow_type = '<div class="arrow-left"></div>';
					arrow_reposition = '';
				}
				else if (arrow_reposition == 'right') {
					arrow_class = 'tooltip-arrow-left';
					arrow_type = '<div class="arrow-right"></div>';
					arrow_reposition = '';
				}
				else {
