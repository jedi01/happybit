...
#// ########################################################################################################
#// Test mode
#// TESTMODE variable will force HAPPYBID to run in "test mode" ($HAPPYBID_TESTMODE = 'yes')
#// or in "live mode" ($HAPPYBID_TESTMODE = 'no')
#//
...
$HAPPYBID_TESTMODE = 'no'; // Possible values: 'yes, 'no'		
#// ########################################################################################################
...
$operation_system = getenv("COMSPEC")? "windows" : "unix";

if ($operation_system=="unix") {
