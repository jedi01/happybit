...
$MSG_103 = " Search ";
$MSG_104 = "Browse ";
$MSG_105 = "<div style='float:left;margin-right: 2px;margin-top: -2px;'><img src='/images/history-icon.png' border='0' /></div><div style='float:left;'>View your bid history</div>";
...
$MSG_507 = "<div style='float:left;margin-right: 2px;margin-top: -2px;'><img src='/images/history-icon.png' border='0' /></div><div style='float:left;'>Hide your bid history</div>";
$MSG_508 = "[user e-mail]";
...
$MSG_30_0054 = "Invalid email address.<br>This email extension is banned, please use a different email address.";
...
$MSG_verified_1 = "<img src='http://happybid.co.uk/images/verified.png'>";
$MSG_verified_0 = "<img src='http://happybid.co.uk/images/verified-no.png'>";
$MSG_connected_1 = "<img src='http://happybid.co.uk/images/fblogo.png' width='16'>";
