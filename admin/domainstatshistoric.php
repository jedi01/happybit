...
#// Retrieve data
$query = "SELECT year FROM HB_currentdomains WHERE (year<>".date("Y")."
...
{
	$query = "SELECT * FROM HB_currentdomains WHERE year=".$year[year]." AND month<>'".date("m")."' GROUP BY month ORDER BY month desc";
